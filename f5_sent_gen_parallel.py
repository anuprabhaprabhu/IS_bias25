...
#/home2/anuprabha.m/dysar_25/envs/f5_tts/bin/
    command = [
        ...
        '--ref_text', ref_text,
        '--gen_text', gen_text,
        '--output_dir', "/home2/anuprabha.m/dysar_25/F5-TTS/src/f5_tts/infer/gen_torgo/",
        '--output_file', output_file
    ]
    subprocess.run(command, check=True, text=True, capture_output=True)


df = pd.read_csv('/home2/anuprabha.m/dysar_25/F5-TTS/src/f5_tts/infer/genfile_torgo_for20sent.csv')
